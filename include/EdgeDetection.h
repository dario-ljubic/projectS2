...
public:
    ...
    // TODO: Otsu method
    //double OtsuThreshold(cv::Mat& src, cv::Mat& dst, double thresh, double maxval, int type);
...
private:
    ...
    std::pair<double, double> FindThresholdValue(double include_factor, double img_median,
                                                 int num_bits);
